...
suffixListAmerica = ['Dulles:Chrome.DSL', 'Texas2', 'NewJersey', 'Toronto:Chrome.DSL', 'Argentina2', 'Chicago:Chrome.DSL',
                    'Nebraska', 'MinasGerais_BR', 'Argentina', 'Colorado', 'gce-us-west1-linux', 'ec2-sa-east-1', 'ec2-us-east-1', 'SanFrancisco',
                    'ec2-us-west-1', 'Florida', 'SaoPaulo_BR']
suffixListAmerica1 = ['SaoPaulo_BR']
temp = ['London']
...
for loc in temp:
    ...
    americaAkamaiIPs = ['104.119.136.151', '23.62.169.196', '172.230.208.91', '172.231.28.66', '104.106.243.165', '23.197.232.59',
                   '104.117.22.193', '104.104.166.91', '23.2.187.144', '23.63.203.42', '96.7.86.249', '173.222.84.211', '23.195.239.200',
                   '72.246.215.93', '184.29.152.237', '23.211.22.137', '23.213.124.11', '23.13.77.126', '23.11.16.189']
    temp1 = ['23.216.206.221', '2.23.131.158', '104.103.109.11', '23.214.189.19', '104.86.40.25', '104.111.244.87',
    ...
    for ip in temp1:
        ...
        url = 'http://www.webpagetest.org/runtest.php?&location=' + loc + '&script=' + script + '&f=json&k=' + key_old
